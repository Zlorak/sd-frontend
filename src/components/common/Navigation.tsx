...
export const Navigation: React.FC = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-800 shadow border-b border-green-200 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center space-x-3 hover:opacity-80 transition-opacity cursor-pointer">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link
              ...
              title="Admin - Manage Makes & Models"
            >
      ...
      <div className="md:hidden">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-green-50 dark:bg-gray-700">
          {navItems.map((item) => {
            const isActive = location.pathname === item.path;
            return (
              <Link
