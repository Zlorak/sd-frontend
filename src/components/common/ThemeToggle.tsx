...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-lg bg-green-100 dark:bg-gray-700 hover:bg-green-200 dark:hover:bg-gray-600 border border-green-200 dark:border-gray-600 transition-all duration-300 hover:scale-105"
